...
- Read-only local web UI: browse / search / screenshots / provenance / page diffs / per-competitor bird's-eye view.
...
## 7. Milestones (~2.5–3 weeks total)

The landscape layer + bird's-eye view add ~1–2 days over Rev 5's estimate; stated, not shaded. Each milestone ends demonstrable:
